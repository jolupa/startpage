...
return [
    'altCommandPlural'   => 'Volies dir una d\'aquestes?',
    'altCommandSingular' => 'Volies dir?',
    'commandNotFound'    => 'L\'ordre "{0}" no es troba.',
    'generator'          => [
        'cancelOperation' => 'L\'operació ha sigut cancelada.',
        'className'       => [
